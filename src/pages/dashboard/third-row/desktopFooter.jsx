...
const DesktopFooter = () => {
  return (
    <div className={`${style.footer} ${style.desktopFooter}`}>
        <div className={style.desktopFooter_item}>
            <div className={style.desktopFooter_item_icon}>
                <img src={products} alt="products" />
            </div>
            <div className={style.desktopFooter_item_text}>
                <h4>Products</h4>
                <p>2,300,300</p>
            </div>
        </div>
